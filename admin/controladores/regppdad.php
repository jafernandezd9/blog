...
if (isset($_POST['botonpd']) && isset($_POST['propietario']) && isset($_POST['tipo'])) {
	...
	$query="INSERT INTO propiedades(tipo_propiedad,depto,ciudad,ubicacion,tamano,precio,caracteristicas,disponibilidad,banos,habitaciones,propietarios_documento)VALUES(?,?,?,?,?,?,?,?,?,?,?)";
	$consulta=$pdo->prepare($query);

	if($consulta->execute(array($tipo,$depto,$ciudad,$ubicacion,$tamano,$precio,$caracteristicas,$disponibilidad,$banos,$habitaciones,$propietario))){
