                            ...
                            <form class="user" action="controladores/regppdad.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                      ...
                                      <select class="form-control" name="propietario" style="border-radius: 10em;" required>
                                    ...
                                    Selecciona el tipo
                                        <select class="form-control " aria-label=".form-select-lg example" style="border-radius: 10em;" required name="tipo">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    Departamento
                                    <select class="form-control " aria-label=".form-select-lg example" style="border-radius: 10em;" name="depto">
                                ...
                                <div class="form-group row">            
                                   <div class="col-sm-12 mb-3 mb-sm-0">
                                        <select class="form-control " aria-label=".form-select-lg example" style="border-radius: 10em;"  required="" name="disponibilidad">
                                ...
                                <div class="form-group row">
                                    <textarea class="form-control " name="caracteristicas" style="border-radius: 10em;">Características
                                    </textarea>        
                                </div>        
                                 <button type="submit" class="btn btn-primary btn-lg" name="botonpd" style="border-radius: 10em;">Registrar propiedad</button>
                                <hr>
                            </form>
                        </div>
                    </div>
