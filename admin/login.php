                                    ...
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Digita tu documento" name="doc">
                                        </div>
                                        <div class="form-group">
...
$query="SELECT * FROM usuarios WHERE Ndocumento=? and Contrasena=?";
$consulta = $pdo->prepare($query);
$consulta->execute(array($doc,$pass));

if($consulta->rowCount()>=1){
    session_start();
    $fila=$consulta->fetch();
    $_SESSION['Nomusuario']=$fila[1]; 
    $_SESSION['Ndocumento']=$fila[0]; 
    $_SESSION['Rol']=$fila[3]; 
    echo "<script>alert('Sesión iniciada.');
